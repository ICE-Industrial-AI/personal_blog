...
1.  **Initialwerte ($i < d$):**
    Die ersten $d$ Werte (aus $\text{SOBOL\_INIT\_M}$) werden geladen und an die korrekte Bit-Position (ganz links) verschoben.
    $$
